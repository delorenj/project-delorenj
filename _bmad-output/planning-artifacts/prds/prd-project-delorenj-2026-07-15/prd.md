...
`[NOTE FOR PM] Fidelity-tier strategy (research-recommended, confirm §8 Q12): rather than four equal waypoints, reserve full-realized 3D for 2–3 signature bookend eras (ground radio-waves + deep-space agentic-AI) and give transitional eras lighter kinetic-type/particle/wireframe treatments. This protects the premium impression on a solo timeline and avoids uneven fidelity. The MVP waypoint list below is the current proposal pending that decision.]`
